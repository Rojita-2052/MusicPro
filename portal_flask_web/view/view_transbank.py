...
def app_transbank_pay_view(app):
    ...
    @app.route('/transbank', methods=['GET', 'POST'])
    def transbank_pay_view():
        ...
        if request.method == 'GET':
            ...
            return render_template('transbank.html', context=context)
            ...
            url = 'http://{0}:{1}/api/v1/transbank/transaccion/crear'.format(host, port)
            print('url: ', url)
